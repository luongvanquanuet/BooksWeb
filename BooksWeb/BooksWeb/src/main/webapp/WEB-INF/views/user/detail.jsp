    ...
    <main>
        <div class="py-5 text-center">
            ...
            <h2>Thông tin user</h2>
                <br>
            <form id="create-user" class="needs-validation">
                <input name="id" value="${user.id}" hidden>
                <div class="row">
                    <div class="col-sm-4">
                        <label class="form-label">Tên đăng nhập</label>
                        <input type="text" class="form-control" name="userName" placeholder="" value="${user.username}" required="true"/>
                    </div>

                    <div class="col-sm-4">
                        <label class="form-label">Họ và tên</label>
                        <input type="text" class="form-control" name="fullName" placeholder="" value="${user.username}" required="true"/>
                    </div>
                    <div class="col-sm-4">
                        <label class="form-label">email</label>
                        <input type="text" class="form-control" name="email" placeholder="" value="${user.email}" required="true"/>
                    </div>
...
<%--                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <input id="password" type="password" class="form-control" name="password" placeholder="" value="${user.password}" required="true"/>
                    </div>
